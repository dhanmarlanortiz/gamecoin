...
<body>
    ...
    <main>
        ...
        <section class="banner">
            <div class="container">
                <h1>Gamecoin</h1>
                <p>The Gamecoin is a crypto token created under XRPL. This platform offers a unique utilization of the token. Gamecoin is solely used to run the game thus, making it more valuable as time goes by</p>
                <a href="#play-game" class="btn btn-dark">
                    Play game
                </a>
            </div>
        </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-4 text-center text-md-start">
                    <ul class="socials ">
                        <li>
                            <a class="social-twitter" href="https://twitter.com/bgamecoin?s=20&t=EAQO9j2v31Crc_ZS0NkMRQ" target="_blank">
